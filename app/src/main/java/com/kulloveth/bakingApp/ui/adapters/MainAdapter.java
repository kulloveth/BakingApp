...
public class MainAdapter extends ListAdapter<Recipe, MainAdapter.MainViewholder> {
    ...
    public MainViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RecipeItemBinding binding = RecipeItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, true);
    ...
    public void onBindViewHolder(@NonNull MainViewholder holder, int position) {
        ...
        holder.steps.setText(holder.itemView.getContext().getString(R.string.steps) + recipe.getSteps());
        if (!recipe.getImage().equals("")) {
            Picasso.get().load(recipe.getImage()).placeholder(R.drawable.snack).into(holder.recipeImage);
        }else{
            Picasso.get().load(R.drawable.snack).placeholder(R.drawable.snack).into(holder.recipeImage);
        }
